...
sw=ROOT/'sw.js'; t=sw.read_text(encoding='utf8'); t=re.sub(r"const CACHE='[^']+';","const CACHE='fr4000-v10-swipe-auto-lock-20260923';",t,count=1); sw.write_text(t,encoding='utf8')
